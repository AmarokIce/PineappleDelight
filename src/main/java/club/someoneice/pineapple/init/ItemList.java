...
public final class ItemList {
  ...
  public static final RegistryObject<Item> PINEAPPLE_SIDE =
      ITEMS.register("pineapple_side", () ->
          ItemUtil.foodItems(1, 0.5f, false, true));
  public static final RegistryObject<Item> PINEAPPLE_PIE_SIDE =
      ITEMS.register("pineapple_pie_side", () ->
          ItemUtil.foodItems(3, 0.1f, false, false));
  public static final RegistryObject<Item> PINEAPPLE_JUICE =
      ITEMS.register("pineapple_juice", () ->
          ItemUtil.foodDrinkItems(5, 0.5f, false, false));
  public static final RegistryObject<Item> PINEAPPLE_FRIED_RICE =
      ITEMS.register("pineapple_fried_rice", () ->
          ItemUtil.foodItems(12, 0.4f, false, false));
  public static final RegistryObject<Item> PINEAPPLE_MILK_SHAKE =
      ITEMS.register("pineapple_milk_shake", () ->
          ItemUtil.foodDrinkItems(5, 0.5f, false, false));
  public static final RegistryObject<Item> PINEAPPLE_ICE_CREAM =
      ITEMS.register("pineapple_ice_cream", () ->
          ItemUtil.foodDrinkItems(5, 0.5f, false, false));
  public static final RegistryObject<Item> PINEAPPLE_CAKE_SLICE =
      ITEMS.register("pineapple_cake_slice", () ->
          ItemUtil.foodItems(3, 0.4f, false, true));
  public static final RegistryObject<Item> PINEAPPLE_OLD =
      ITEMS.register("pineapple_old", ItemOldPineapple::new);
  public static final RegistryObject<Item> PINEAPPLE_MACE_HAND =
